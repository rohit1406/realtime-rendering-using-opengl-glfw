/*
	...
	1. Creates four lines from four points - set output to line_strip
	2. Create House - Set output to triangle_strip and draw 3 triangles
...
//camera
Camera camera(glm::vec3(0.0f, 0.0f, 2.0f) //position
				);
...
int main()
{
	...
	while (!glfwWindowShouldClose(window)) //check if GLFW has been instructed to close
	{
		...
		//draw points
		glDrawArrays(
			GL_POINTS, //what we want to draw using the vertices given in the shader program object
