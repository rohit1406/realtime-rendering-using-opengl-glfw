/*
	...
	If you run this program, you will see everything white making it look like all of our z-values are 1.0 which is maximum depth value
	Depth values in screen space are non-linear i.e. they have high precision for small z-values and a low precision of larger z-values.
	Depth value of a fragment increases rapidly over distance so almost all vertices have values close to 1.0.
	If you move really close to object, you might eventually see colors getting darker, showing there z-values are becoming smaller.
	This clearly shows the non-linearality of depth values.
