/*
	...
	Post Processing Effects - Grayscale Effect
	Remove all colors from the screen except white, gray and black effectively grayscaling the entire image.
	Can be done by averaging all the color components
