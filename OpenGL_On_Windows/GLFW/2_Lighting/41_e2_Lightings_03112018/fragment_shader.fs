...
vec3 specular_lighting = light.specular * (spec * (vec3(1.0) - vec3(texture(material.specular, out_texcoords)))); //here we invert the sampled specular color; Black becomes white and white becomes black
