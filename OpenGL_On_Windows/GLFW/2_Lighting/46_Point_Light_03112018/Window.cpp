/*
	...
	Program Name - Point Light
	a light source with position somewhere in the world that illuminates in all direction but the light rays fade out over distance
	e.g. Light bulb or torch
