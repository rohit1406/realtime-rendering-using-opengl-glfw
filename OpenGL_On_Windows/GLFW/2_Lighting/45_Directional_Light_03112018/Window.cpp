/*
	...
	Program Name - Directional Light
	When a light source is far away that the light rays coming from it are close to parallel 
	to each other - e.g. Sun. Light source is modelled at infinite distance
