/*
	...
	Program Name - Diffuse Maps
	This is just a different name for the underlying principle of textures. In lighting, we call it as diffuse maps
...
int main()
{
	...
	while (!glfwWindowShouldClose(window)) //check if GLFW has been instructed to close
	{
		...
		lighting_shader.setFloat("material.diffuse", 0); //set 0th texture unit
