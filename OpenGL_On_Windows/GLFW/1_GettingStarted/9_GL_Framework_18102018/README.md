## 🌱 Description
The program is a demonstration of how to render a triangle using OpenGL. **Shader code is seperated from the Cpp file.** GLFW library is used for the window management and OpenGL context management. To generate binary .exe file, follow [below steps](#how-to-run). Once .exe file is  executed, a new window will appear with an output rendered on it.
